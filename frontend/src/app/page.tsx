        ...
        <div className="mt-16 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Track your progress and mark tasks as complete</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Find tasks quickly with powerful search and filtering</p>
            </div>
          </div>
        </div>
      </div>
